...
There are four **Filters** and **20 Layers** available for the user, as well as dedicated buttons to quickly extract and combine geometry from all Layers.
...
.. figure:: https://i.imgur.com/vyXpR4X.png
	:class: with-shadow float-right
	:width: 100px
...
.. figure:: https://i.imgur.com/uJUZGFN.png
	:class: with-shadow float-right
	:width: 100px

- **Filter Curves** - this filter will show only **Curves** and hide the **Geometry** in all the Layers.

.. figure:: https://i.imgur.com/kHVHiEo.png
	:class: with-shadow float-right
	:width: 100px

- **Filter Geo** - this filter will show only **Geometry** and hide all the **Curves** in all the **Layers**.

.. figure:: https://i.imgur.com/9hNlTKW.png
	:class: with-shadow float-right
	:width: 100px

- **Color** - this filter will activate a special **Colorize Mode**. In this mode all the **Geometry** will be colored based on the **Layer** color. **Layer** color is assigned randomly at first, but you can always manually change it using **Curve Control Window** and clicking the color box at the top of the window. Color is **Layer** based. Clicking on this button again will restore the original materials of the Geometry. There are two options available for the color mode:
	...
	- **Color Only** - this mode can be activated in the Options menu and it will only show colors for each individual **Layer**. This mode is useful if you want to quickly check which **Curve** is assigned to which **Layer**.

	.. figure:: https://i.imgur.com/3KzcMTB.png
		:class: with-shadow
		:width: 500px
...
.. figure:: https://i.imgur.com/qUdQSkr.gif
	:class: with-shadow float-right
	:width: 250px
...
.. figure:: https://i.imgur.com/c5Yqv6V.gif
	:class: with-shadow float-right
	:width: 250px
...
.. figure:: https://i.imgur.com/ICm5FQC.gif
	:class: with-shadow float-right
	:width: 150px
...
.. figure:: https://i.imgur.com/yyz7sg3.png
	:class: with-shadow float-right
	:width: 45px
...
.. figure:: https://i.imgur.com/33fz7Ku.png
	:class: with-shadow float-right
	:width: 45px
...
.. figure:: https://i.imgur.com/C4SIbJK.png
	:class: with-shadow float-right
	:width: 45px
...
.. figure:: https://i.imgur.com/C1rDRe5.png
	:class: with-shadow float-right
	:width: 45px
...
.. figure:: https://i.imgur.com/1UNduCE.png
	:class: with-shadow float-right
	:width: 150px
...
.. figure:: https://i.imgur.com/KBkk50o.png
	:class: with-shadow float-right
	:width: 300px
...
.. figure:: https://i.imgur.com/nYBFkJD.png
	:alt: Creation Section
	:class: with-shadow
	:width: 150px

.. figure:: https://i.imgur.com/UaTI7O7.gif
	:alt: Creation Section
	:class: with-shadow float-right
	:width: 250px
...
.. figure:: https://i.imgur.com/3kx1xZh.png
	:alt: Creation Section
	:class: with-shadow
	:width: 150px

.. figure:: https://i.imgur.com/alvLADs.gif
	:alt: Creation Section
	:class: with-shadow float-right
	:width: 250px
